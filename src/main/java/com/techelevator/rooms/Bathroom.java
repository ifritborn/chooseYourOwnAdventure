...
public class Bathroom {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Bathroom ";
    ...
    //go options
    private static final String GO_1 = "Go to the Dining Room";
    private static final String GO_2 = "Go to the Movie Theatre";
    ...
    private static DiningRoom diningRoom = new DiningRoom();
    private static MovieTheatre movieTheatre = new MovieTheatre();
