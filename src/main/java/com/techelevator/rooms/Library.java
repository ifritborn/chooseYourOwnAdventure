...
public class Library {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Library. ";
    ...
    //go options
    private static final String GO_1 = "Go to the Movie Theatre";
    private static final String GO_2 = "Go to the Study";
