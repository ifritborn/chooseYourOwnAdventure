...
public class MovieTheatre {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Movie Theatre.";
    ...
    //go options
    private static final String GO_1 = "Go to the Bathroom";
    private static final String GO_2 = "Go to the Library";
