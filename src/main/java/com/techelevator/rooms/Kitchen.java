...
public class Kitchen {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Kitchen. ";
    ...
    //go options
    private static final String GO_1 = "Go to the Garage";
    private static final String GO_2 = "Go to the Dining Room";
