...
public class Garden {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Garden. ";
    ...
    //go options
    private static final String GO_1 = "Go to the Game Room";
    private static final String GO_2 = "Go to the Garage";
