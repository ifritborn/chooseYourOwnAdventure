...
public class Garage {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Garage. ";
    ...
    //go options
    private static final String GO_1 = "Go to the Garden";
    private static final String GO_2 = "Go to the Kitchen";
