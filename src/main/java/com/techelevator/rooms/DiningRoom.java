...
public class DiningRoom {
    //Variables
    //Room intro
    private static final String INTRO = "You enter the Dining Room. ";
    ...
    //go options
    private static final String GO_1 = "Go to the Kitchen";
    private static final String GO_2 = "Go to the Bathroom";
